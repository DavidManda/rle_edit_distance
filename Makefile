edit_dist: rle_edit_distance.cpp
	g++ -g -O0 run_edit_dist.cpp test_rle_edit_distance.cpp test_avl_tree.cpp rle_edit_distance.cpp segment.cpp point.cpp avl_tree.cpp helper.cpp rle.cpp -o run_edit_distance.o
example:
